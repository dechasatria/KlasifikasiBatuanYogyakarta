...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [109.054430, -8.622107, 111.465869, -6.866526], maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:4326',
            //extent: [109.765496, -8.211049, 110.913800, -7.416706],
            units: 'degrees'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([109.054430, -8.622107, 111.465869, -6.866526], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Peta Klasifikasi Batuan Yogyakarta</h2>';
        return titleElement;
    })(),
